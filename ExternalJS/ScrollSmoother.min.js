  ...
  function ScrollSmoother(t) {
        ...
        if (s) {
          ...
          var t = (function _autoDistance(e, t) {
            ...
            return (
              0 < c &&
                ((n =
                  0.5 == (r = a.height / (L.innerHeight + a.height))
                    ? 2 * a.height
                    : 2 *
                ...
                if (e.offset) {
                  if (i) {
                    ...
                    o =
                      ...
                      a +
                      v *
                        ((B.utils.clamp(e.start, e.end, r) - e.start - a) /
                          (n - e.start) -
                          c);
                  }
                  m.length &&
                    ...
                    l
                      ? (l.resetTo("y", o, -H, !0), O && l.progress(1))
    ...
    function refreshHeight() {
      return (
        ...
        (j.style.height = L.innerHeight + (e - L.innerHeight) / k + "px"),
        e - L.innerHeight
      );
    }
    ab(),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? f
            ? B.to(o, { duration: R, scrollTop: n, overwrite: "auto", ease: Q })
            : P(n)
          : Ua(n);
      }),
        ...
        if (arguments.length) {
          ...
          return (
            t !== n &&
              ...
              R || B.set(n, { clearProps: "transform" })),
            this
          );
        }
        return n;
        ...
        return arguments.length
          ? ((w =
              ...
              (function _wrap(e) {
                ...
                return (
                  t ||
                    ((t = q.createElement("div")).classList.add(
    ...
    z.forEach(function (e) {
        ...
        onRefreshInit: function onRefreshInit(e) {
          if (!ScrollSmoother.isRefreshing) {
            ...
            (d = r && r._end > r._dp._time),
              ...
              (M.y = 0),
              R &&
                (1 === V.isTouch && (w.style.position = "absolute"),
                (w.scrollTop = 0),
                1 === V.isTouch && (w.style.position = "fixed"));
          }
        },
      ...
      (this.smooth = function (e) {
        return (
          arguments.length &&
            ((k = ((R = e || 0) && +t.speed) || 1), i.scrubDuration(e)),
          ...
          ? (!!f !== e &&
              (e
                ...
                : (f.nested.kill(),
                  ...
                  (f = 0),
                  r && r.enable(),
                  (i.progress = (-A / k - i.start) / (i.end - i.start)),
                  Sa(i))),
            this)
          : !!f;
      }),
      (this.kill = this.revert =
        function () {
          ...
          for (var e = (S || []).concat(a || []), t = e.length; t--; )
            e[t].kill();
          V.scrollerProxy(w),
            V.removeEventListener("killAll", ab),
            V.removeEventListener("refresh", _a),
            (w.style.cssText = l),
            (n.style.cssText = c);
          var r = V.defaults({});
          r && r.scroller === w && V.defaults({ scroller: L }),
            o.normalizer && V.normalizeScroll(!1),
            clearInterval(s),
            ($ = null),
            N && N.disconnect(),
            j.style.removeProperty("height"),
            L.removeEventListener("focusin", Xa);
        }),
      ...
      _ &&
        (this.normalizer = V.normalizeScroll(
          !0 === _ ? { debounce: !0, content: !R && n } : _
        )),
      V.config(t),
      "overscrollBehavior" in L.getComputedStyle(j) &&
        B.set([j, I], { overscrollBehavior: "none" }),
      "scrollBehavior" in L.getComputedStyle(j) &&
        B.set([j, I], { scrollBehavior: "auto" }),
