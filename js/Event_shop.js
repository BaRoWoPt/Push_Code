...
//   window.location.href = "PurchaseConfirm.php";
//   return true;
// }
...
//     phoneSpan.setAttribute('name','phoneSpan');
...
//     quantitySpan.setAttribute('name','quantitySpan');
...
//     priceSpan.setAttribute('name','priceSpan');
