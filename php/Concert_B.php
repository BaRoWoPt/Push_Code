...
<body>
    ...
    <div id="pages" class=" pages">
        <!-- trang page chua het cac section -->
        <div class="page_show">
                    ...
                    <div class="page_main">
                        <div class="cover">
                            ...
                            <div class="footer_page">
                                <h1 class="content_page">Âm nhạc giúp chúng ta thư giãn, chữa lành, hãy thưởng thức âm
                                    nhạc bằng cả con tim.
                                </h1>
                                <footer class="fade-right">
                                    <p class="scroll">Cuộn Xuống</p>
    ...
    <div class="light_type">
        <div id="smooth-wrapper">
            <div id="smooth-content">
                <section id="textSection1">
                    <div class="containerText">
                        <div class="wrapper1">
                            <p class="white">Chia sẻ cảm xúc, kết nối kỷ niệm cùng với âm nhạc</p>
                        </div>
                    </div>
                </section>
            </div>
        ...
        <div id="smooth-wrapper">
            <div id="smooth-content">
                <section id="textSection2">
                    <div class="containerText">
                        <div class="wrapper2">
                            <p class="white">Chinh phục niềm vui, trải nghiệm sự kiện đỉnh cao.</p>
                        </div>
                    </div>
                </section>
            </div>
