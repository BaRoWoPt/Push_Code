...
<body>
    <div class="header">
        ...
        <div class="menu-items">
            ...
            <a href="./Layout_concert.php" class="items border_bottom">
    ...
    <div class="page_main">
        <div class="page_container">
            <header class="about_me">
                <h1 class="text_container">
                    <span class="text">Sự </span>
                    <span class="text">Kiện</span>
                </h1>
            </header>
            <div class="footer_show">
                <footer class="fade-right">
                    <div class="scoll_left">
                        <div class="marquee ">
                            <div class="underline_fade">
            ...
            <section class="sign_up" id="sign_up">
                <form id="form_1" class="form" action="PurchaseConfirm.php" method="post">
                    <div class="content_form">
                        <h2>Điền form dưới để đăng kí mua vé trước nhé các bạn ơi.</h2>
                        ...
                        <p style="color:white;">
                            Số vé còn lại <strong style="color:red;"><?php echo $total['ticketleft']; ?></strong> vé!
                        </p>
                        <div class="form_sign">
                            <div class="info">
                            ...
                            <div class="submit_form">
                                <?php
                                // Check if ticketleft is greater than 0, then display the button
                                if ($total['ticketleft'] > 0) {
                                    echo '<button id="done" class="done" type="submit" name="btn-submit">Đặt vé</button>';
                                } else {
                                    echo '<button id="done" class="done" type="button" disabled>Đã hết vé</button>';
                                }
                                ?>
